...
struct MP_SERVERLIST_ADD              { STACKED ULONG MethodID; STACKED STRPTR Name; STACKED STRPTR Address; STACKED ULONG Port; STACKED STRPTR Password; STACKED STRPTR Charset; STACKED ULONG Flags;  };
struct MP_SERVERLIST_IMPORTLISTASTEXT { STACKED ULONG MethodID; STACKED STRPTR Name; };
struct MP_SERVERLIST_EXPORTLISTASTEXT { STACKED ULONG MethodID; STACKED STRPTR Name; };
