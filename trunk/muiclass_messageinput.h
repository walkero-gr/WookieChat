...
struct MP_MESSAGEINPUT_FIND   { STACKED ULONG MethodID; STACKED APTR First; STACKED char *Message; STACKED ULONG Length; STACKED ULONG Mode; STACKED ULONG Direction; };
struct MP_MESSAGEINPUT_ADD    { STACKED ULONG MethodID; STACKED char *Message; };
struct MP_MESSAGEINPUT_REMOVE { STACKED ULONG MethodID; STACKED APTR History; };
